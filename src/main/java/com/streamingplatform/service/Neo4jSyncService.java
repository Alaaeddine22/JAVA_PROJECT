...
public class Neo4jSyncService {
    ...
    private void syncConsumers() {
        ...
        String[] consumers = { "Dashboard-UI", "Analytics-Service", "Alert-System", "Logger", "Backup-Service" };
        String[] subscribedTopics = { "UserLogins", "PaymentEvents", "Errors", "SystemLogs", "ClickStream" };
